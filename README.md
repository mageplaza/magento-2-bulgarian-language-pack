...
Unzip the compressed file and upload file `master.zip` into `app/i18n/Mageplaza/bg_bg/bg_BG.csv`

See this screenshot

![Bulgarian pack](https://cdn2.mageplaza.com/media/general2/tS668yC.png)
